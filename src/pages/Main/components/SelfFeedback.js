...
const SelfFeedback = ({selfFeedback}) => {
    ...
    return (
        <div className="w-[80%] p-6 bg-white border-2 rounded-lg shadow-md border-primary-40">
    ...
    //         <div
    //             className="p-4 text-lg font-medium text-center font-paperlogy-title text-grayscale-100">
    //             {formatContent(selfFeedback)}
    //         </div>
    //     </div>
    // );
