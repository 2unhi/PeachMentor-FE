...
const StatisticsPage = () => {
  ...
  return (
    <div className="w-full h-full max-w-[500px] mx-auto flex flex-col bg-white relative">
      <Header />
      <div className="flex flex-col items-center flex-grow p-4">
        ...
        <AnalysisReport analysisText={analysisText} />
      </div>
      <NavBar className="fixed bottom-0 left-0 w-full" />
      {/* 그래프 좌우 스크롤바 숨김 처리 */}
      <style jsx>{`
        .scrollbar-hide {
